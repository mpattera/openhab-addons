...
/**
 * Static metadata known for one alarm zone.
 *
 * <p>
 ...
 */
@NonNullByDefault
public record ZoneMetadataSnapshot(int id, Map<ZoneMetadataField, String> values) {
     ...
     */
    public @Nullable String get(ZoneMetadataField field) {
