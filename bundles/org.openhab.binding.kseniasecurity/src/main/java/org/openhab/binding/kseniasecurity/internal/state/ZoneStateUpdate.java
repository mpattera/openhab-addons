...
/**
 * A partial status update for one alarm zone.
 *
 * <p>
 ...
 */
@NonNullByDefault
public record ZoneStateUpdate(int id, Map<ZoneStateField, String> values, Set<ZoneStateField> clearedFields) {
     ...
     */
    public ZoneStateUpdate(int id, Map<ZoneStateField, String> values) {
